...
const ChatBot = () => {
  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      const welcomeMessage = {
        ...
        type: "bot",
        content:
          "Hi! I'm Kireeti's AI assistant. I can help you learn more about his projects, skills, and experience. What would you like to know?",
        timestamp: new Date(),
      };
  ...
  const getSystemPrompt = () => {
    ...
    return `You are Kireeti Sangala's friendly and professional AI assistant embedded on his portfolio website. Your goal is to answer questions about his skills, experience, and projects based ONLY on the information provided below. Keep your answers concise, helpful, and speak from a first-person perspective as if you are Kireeti's assistant (e.g., "Kireeti's experience includes..."). Do not make up information. If a question is outside the context, politely state that you can only answer questions about Kireeti's portfolio. give response beautifully without stars and point wise.

---

**Kireeti's Portfolio Information:**

**Projects:**
- **ArtCollab:** Artist collaboration platform using React, Tailwind CSS, Vite, and Firebase. Features real-time multi-user collaboration, project sharing, Firebase Authentication, and responsive design.
- **Job Portal System:** Recruitment platform built with React, Node.js, Express, MongoDB, and JWT. Includes role-based access, dynamic filtering, search, pagination, and optimized database queries.
...
- Problem Solving, Collaboration & Communication, Fast Learner, Attention to Detail
- Hobbies: Playing chess, watching anime, exploring business strategies
`;
  };
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs opacity-90">Ask me about Kireeti</p>
                  </div>
                </div>
                <button
