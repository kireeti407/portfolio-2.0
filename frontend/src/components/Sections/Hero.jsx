        ...
        <div className="flex flex-col-reverse md:flex-row items-center md:items-start gap-8">
          ...
          <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <motion.div variants={itemVariants} className="w-full">
              <h2 className="text-lg md:text-xl text-gray-700 dark:text-gray-300 mb-6 font-light">
                Full Stack Developer & B.Tech Graduate
              </h2>
            </motion.div>

            <motion.div variants={itemVariants} className="w-full">
              <p className="text-base md:text-lg text-gray-600 dark:text-gray-400 mb-8 max-w-3xl leading-relaxed mx-auto md:mx-0">
          ...
          {/* Profile Photo */}
          <motion.div variants={itemVariants} className="flex justify-center md:justify-end mb-8 md:mb-0 md:ml-8 w-full md:w-auto">
            <motion.img
              src={profileImg}
              alt="Profile"
